            ...
            <div className="z-10 flex flex-col items-stretch gap-12 md:flex-row">
              <div className="p-3 md:flex-1">
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  <button className="group flex flex-row items-center gap-6 rounded-full bg-gray-900 px-9 py-3 font-montserat text-2xl font-semibold text-white outline outline-1 outline-gray-500/50 hover:shadow-lg hover:shadow-white/50 hover:outline-2">
                    More
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
